<x-filament::page>
          ...
          <div class="divide-y divide-gray-100 dark:divide-gray-700 max-h-[400px] overflow-y-auto">
            @forelse ($cart as $index => $item)
              <div class="px-4 py-3 flex items-center gap-4">
                ...
                {{-- Discount Button --}}
                <button wire:click="openDiscountModal({{ $index }})"
                  class="ml-2 px-2 py-1 text-xs font-medium rounded border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            {{ $item['discount'] > 0
            ...
            @empty
              <div class="px-4 py-12 text-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mx-auto text-gray-300 dark:text-gray-600 mb-3"
  ...
  @if ($showBarcodeModal)
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-sm p-6">
        <h3 class="text-lg font-semibold text-center mb-3">Scan QRIS</h3>
